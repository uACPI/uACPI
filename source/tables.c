...
#define ENSURE_TABLES_ONLINE() do {                                               \
...
#define uacpi_acquire_native_mutex_may_be_null(mtx) UACPI_STATUS_OK
#define uacpi_release_native_mutex_may_be_null(mtx) UACPI_STATUS_OK
